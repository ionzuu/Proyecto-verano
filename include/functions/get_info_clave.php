        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr class="tr"><!-- Cambia name e id -->
                    ...
                    <td class="td"><a id="edit" name="edit" class="btn_action" href="editclave.php?inf=<?php echo $row['id_clavemateria']; ?>">Editar</a><a id="delete" name="delete" class="btn_action" href="../include/functions/process_clave.php?inf=<?php echo $row['id_clavemateria']; ?>" onclick="return confirm('¿Seguro que desea eliminarlo?')">Eliminar</a></td>
                </tr>
                <?php
                    } ?>
                <tr>
                    <form action="../include/functions/process_clave.php" method="post">
                    <td class="td data"><input type="text" name="addnombreclave" id="addnombreclave" placeholder="clave" required></td>
