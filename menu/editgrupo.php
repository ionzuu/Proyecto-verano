            ...
            <div class="col-md-10 form- div-login pt-4 pb-5">
                <div class="container_select">  
                    <div class="header_title_select">
                        <h3 class="h3_title h3_group">Grupos</h3><hr>
                    </div>
                    <div class="main_menu">
                        <div id="result" class="result">
                            <div class="container_form">
                                <form action="../include/functions/process_grupos.php" method="post">
                                        ...
                                        $user = new Database();
                                        $id = $_GET['inf'];
                                        $_SESSION['idgrupos'] = $id;
                                        $resultado=$user->search("grupo","$id = id_grupo");
                                        foreach ($resultado as $row) {
                                        ?>
                                        <div class="seccion_form secc_form_group">
                                        <label class="label_edit">Grupo:</label><br>
                                        <input type="text" class="input_edit" name="grupo" id="grupo" placeholder="<?php echo $row['numero_grupo']; ?>">
                                        </div>
