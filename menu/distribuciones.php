	...
	?>
        ...
        <div class="row justify-content-center pt-5 mt-5 mr-1" style=" margin-top: 0 !important;">
            <div class="col-md-10 form- div-login pt-4 pb-5">
                <div class="container_select container_select_dist">  
                    <div class="header_title_select">
                        <h3 class="h3_title grupo_title">Distribucion</h3><hr>
                    </div>
                    <div class="main_menu">
                        <div id="result" class="result result_dist"><?php include '../include/functions/get_info_distribucion.php'; ?></div>
                    </div>
                </div>
            </div>
        </div>
