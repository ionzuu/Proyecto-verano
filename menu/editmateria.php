            ...
            <div class="col-md-10 form- div-login pt-4 pb-5">
                <div class="container_select">  
                    <div class="header_title_select">
                        <h3 class="h3_title">Materia</h3><hr>
                    </div>
                    <div class="main_menu">
                        <div id="result" class="result">
                            <div class="container_form">
                                <form action="../include/functions/process_materia.php" method="post">
                                        ...
                                        $resultado=$user->search("materia","$id = id_materia");
                                        foreach ($resultado as $row) {
                                        ?>
                                        <div class="seccion_form">
                                        <label class="label_edit">Materia:</label><br>
                                        <input type="text" class="input_edit" name="materia" id="materia" placeholder="<?php echo $row['nombre_materia']; ?>">
