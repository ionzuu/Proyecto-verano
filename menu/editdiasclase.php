            ...
            <div class="col-md-10 form- div-login pt-4 pb-5">
                <div class="container_select">  
                    <div class="header_title_select">
                        <h3 class="h3_title">Dias clase</h3><hr>
                    </div>
                    <div class="main_menu">
                        <div id="result" class="result">
                            <div class="container_form">
                                <form action="../include/functions/process_diasclase.php" method="post">
                                        ...
                                        $id = $_GET['inf'];
                                        $_SESSION['iddias'] = $id;
                                        $resultado=$user->search("dia","$id = id_dia");
                                        foreach ($resultado as $row) {
                                        ?>
                                        <div class="seccion_form">
                                        <label class="label_edit">Dia:</label><br>
                                        <select name="dia" id="dia" class="input_edit diasclase">    
                                        ...
                                        <input type="text" class="input_edit" name="desc" id="dia" placeholder="<?php echo $row['descripcion']; ?>">
                                        </div>
                                        </div>
